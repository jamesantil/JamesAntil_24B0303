...
by the problem statement, all tradeable on / linked to Indian markets):
    ...
    BONDS   NETFLTGILT.NS  Nippon India ETF Long Term Gilt (rate-sensitive duration asset)
...
- NETFLTGILT.NS is a long-duration government-bond ETF, so it actually behaves like
...
EQUITY_TICKER = "^NSEI"
BOND_TICKER_PRIMARY = "NETFLTGILT.NS"
